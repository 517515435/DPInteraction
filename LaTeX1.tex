...
\begin{abstract}
%Factorization with Non-random Missing Label （FNRML）？
...
\textbf{DTI Prediction Performance.} We first evaluate the accuracy of DTI prediction of the proposed FNML model. The number of dimensions for drug features are $K=100$, for target features $L=400$, hyper-parameters are $\sigma^2=1,\eta_{0}=1,\eta_{1}=1$. 
