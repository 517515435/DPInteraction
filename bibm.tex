...
\scalebox{0.8}{
\subfigure[AUPR]{
\includegraphics[width=5cm,height=3.5cm]{Ensemble_TraditionalEnsembleAUPR.eps}
\label{fig:allaupr}
}
\subfigure[AUROC]{
\includegraphics[width=5cm,height=3.5cm]{Ensemble_TraditionalEnsembleAUROC.eps}
\label{fig:allauroc}
}}
\vspace*{-10pt}
